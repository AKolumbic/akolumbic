...
// Import shader code from MainBackground.tsx
...
// Simplified smoke effect component
...
// Three.js background implementation that will be dynamically imported
export const DynamicMainBackground: React.FC<BackgroundProps> = ({
  reducedMotion = false,
}) => {
  return (
    <div
